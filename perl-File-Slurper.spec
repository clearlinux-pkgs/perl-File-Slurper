...
Source0  : https://cpan.metacpan.org/authors/id/L/LE/LEONT/File-Slurper-0.013.tar.gz
...
%prep
%setup -q -n File-Slurper-0.013
cd %{_builddir}
tar xf %{_sourcedir}/libfile-slurper-perl_0.012-1.debian.tar.xz
cd %{_builddir}/File-Slurper-0.013
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/File-Slurper-0.013/deblicense/
...
cp %{_builddir}/File-Slurper-0.013/LICENSE %{buildroot}/usr/share/package-licenses/perl-File-Slurper/d13cf3593e627dadc2f1363b8b5b12fd67c37934
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/File/Slurper.pm
